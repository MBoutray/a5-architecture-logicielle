...
function Kill() {
  ...
  return (
    <>
      <Navbar />
        <div>
            <h1 className="text-4xl font-bold text-center text-white my-10">Kill the target</h1>
        </div>
        <div className='flex justify-center'>
            <img src={killer} className="w-80 h-96 object-cover object-center my-4" alt="Kill" />
